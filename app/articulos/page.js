...
// Configuración de Supabase (Lado Servidor)
...
export default async function ArticulosPage() {
  // 1. Obtener artículos desde Supabase directamente en el servidor
          ...
          {articulos?.map((art) => (
            <article key={art.id} className="bg-white rounded-xl shadow-md overflow-hidden hover:shadow-lg transition">
              ...
              <div className="p-6">
                ...
                {/* Llamada al componente cliente para los botones de compartir */}
